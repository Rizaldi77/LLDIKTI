                ...
                <div class="card-body">
                    <form method="POST" action="/proses">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="noktp" value="{{ old('noktp') }}" required>
                        </div>
                        <div class="form-group">
                            <label>No Telepon</label>
                            <input type="text" class="form-control" name="notelp" value="{{ old('nohp') }}" required>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keperluan" class="form-control" cols="30" rows="10" required>{{ old('keperluan') }}</textarea>
                        </div>
                        <div class="form-group">
